...
les permutation des lettres, et d'un réflecteur qui renvoie le courant
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[scale=0.5]{eps/Enigma}
    \hspace{3cm}
...
\emph{Lorenz SZ 40/42}, surnommée \emph{Tunny} par les alliés. Le
...
repositionnés leurs machine de Lorenz dans la même position que pour
...
% Beaucoup dans les années 70
% Diffie et Hellman -> clé publique
% DES
% RSA

% 90's
% IDEA (juste citer vite fait ?)
% Premièrs abords de la crypto quantique
% PGP
% MD4, MD5, blowfish
