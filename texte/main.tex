...
% Espaces conseillés, mais non utilisés :
%\usepackage[top=2cm, bottom=1cm, left=4cm, right=3cm]{geometry}
% Interligne
...
\def\maketitle{
  ...
  \begin{center}
    ...
    \includegraphics[width=0.2\textwidth]{images/cadenas.jpg}
  \end{center}
...
\renewcommand{\footref}[1]{\footnote{Voir chapitre \ref{#1}, p\pageref{#1}}}
\renewcommand{\thesubsection}{\thesection .\alph{subsection}}
\newcommand{\note}[1]{\begin{center}\begin{minipage}{0.7\textwidth}\textsc{Note
          : }#1\end{minipage}\end{center}}
\newcommand{\bc}[1]{#1\ieme~ siècle av. J.-C.}
